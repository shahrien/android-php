...
public class MainActivity extends AppCompatActivity {
    ...
    private void getCourseDetails(String courseId) {
        ...
        String url = "http://10.80.23.212:80/test_php/index.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (jsonObject.getString("id") == null) {
                        ...
                        courseNameTV.setText(jsonObject.getString("id"));
                        courseDescTV.setText(jsonObject.getString("username"));
                        courseDurationTV.setText(jsonObject.getString("password"));
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                courseNameTV.setText("this" + error);
